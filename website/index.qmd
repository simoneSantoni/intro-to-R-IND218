...
[Start with Module 1](modules/module-1/installing-r.qmd){.btn .btn-primary .btn-lg role="button"} [View the course schedule](course/schedule.qmd){.btn .btn-outline-primary .btn-lg role="button"}
:::
